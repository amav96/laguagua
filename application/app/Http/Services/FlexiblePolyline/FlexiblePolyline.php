...
namespace App\Http\Services\FlexiblePolyline;

use App\Http\Services\FlexiblePolyline\Traits\DecodableTrait;
use App\Http\Services\FlexiblePolyline\Traits\EncodableTrait;
