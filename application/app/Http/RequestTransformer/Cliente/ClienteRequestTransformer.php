...
class ClienteRequestTransformer {
    ...
    public function transform(): array
    {
        return array_filter([
            ...
            "numero_documento"  => isset($this->data["numero_documento"]) ? getNumbers($this->data["numero_documento"]) : null,
            "empresa_id"        => $this->data["empresa_id"],
            "clientes_numeros"  => $this->data["clientes_numeros"],
            "observaciones"     => isset($this->data["observaciones"]) ? $this->data["observaciones"] : null
        ]);
    }
